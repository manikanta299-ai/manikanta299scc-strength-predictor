...
wb = st.number_input("Water_Binder_Ratio",0.40)
sp = st.number_input("Superplasticizer_Percentage",1.5)
...
sg = st.number_input("Specific_Gravity",2.3)

slump = st.number_input("Slump_Flow",650.0)
t500 = st.number_input("T500_Time",4.0)
vfunnel = st.number_input("V_Funnel_Time",10.0)
lbox = st.number_input("L_Box_Ratio",0.85)
...
if predict:
input_data = pd.DataFrame([[cement,replacement,wb,sp,sio2,al2o3,fe2o3,cao,mgo,loi,sg,slump,t500,vfunnel,lbox,split,rcpt]],
